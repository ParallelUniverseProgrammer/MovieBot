...
def build_minimal_system_prompt() -> str:
    ...
    return (
        ...
        "\n- For recommendation queries (e.g., 'find early X films', 'show me Y movies'), always call `search_plex` to check library availability before showing `[Plex]` tags."
        ...
        "\n- Superlatives: map directly to Plex sorts/filters (combine with genres/actors/directors when present):"
